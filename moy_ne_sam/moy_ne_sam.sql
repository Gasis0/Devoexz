...
--
-- Хост: localhost
-- Время создания: Дек 11 2025 г., 08:19
...
CREATE TABLE `service` (
  ...
  `reason_cancel` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(7, 'adawfdaf', 9, 1, '2025-12-12', '12:21:00.000000', 1, 1, '123');
...
(1, 2, 'Годзь', 'Вероника ', 'Александровна', '79257342008', 'vgodz_s@mail.ru', 'adminka2', '5f4dcc3b5aa765d61d8327deb882cf99'),
(2, 2, 'Гудожникова', 'Алина', 'Юрьевна', '79775665099', 'alinka@12mail.ru', 'adminka', '5f4dcc3b5aa765d61d8327deb882cf99'),
(3, 1, 'Артемка', 'Крутой', 'Папный', 'айфон 13', 'ur0dec@gmail.ru', 'artimka', '827ccb0eea8a706c4c34a16891f84e7b'),
(5, 1, '1', '1', '1', '1', '1@a', '1', 'c4ca4238a0b923820dcc509a6f75849b'),
(9, 1, '2', '2', '2', '2', '2@2', '2', 'c81e728d9d4c2f636f067f89cc14862c');
...
--
ALTER TABLE `service`
  MODIFY `id_service` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
