...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        error_log("DEBUG: surname='$surname', name='$name', otchestvo='$otchestvo', phone='$phone', email='$email', login='$login', password='[hidden]'");

        // user_type_id = 1 - обычный пользователь INSERT INTO `user` (`ID`, `surname`, `name`, `otchestvo`, `phone`, `email`, `username`, `password`, `user_type_id`) VALUES (NULL, '3', '3', '3', '3', '3', '3', '3', '2');
        $sql = "INSERT INTO user (surname, name, otchestvo, phone, email, username, password, user_type_id) 
                VALUES ('$surname', '$name', '$otchestvo', '$phone', '$email', '$login', MD5('$password'), '2')";
